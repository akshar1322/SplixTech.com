...
const updates: Update[] = [

  {
    ...
    name: 'Beta - 2.00.0.A',
    version: '2.00.0.A',
    dateTime: 'Wednesday, November 13, 2024 10:10 AM', // This will automatically fetch the current date and time
    title: 'Beta Release 2.00.0.A - We Updated the UI, Improved Performance, and More!',
